...
namespace TKCommon.Utility
{
    public class SparseVectorUtility
    {
        ...
        {
            StopWatchLogger.StartEventWatch("VectorByMatrix");
            ...
            StopWatchLogger.StopEventWatch("VectorByMatrix");
        ...
        {
            StopWatchLogger.StartEventWatch("MatrixByMatrix");
            ...
            StopWatchLogger.StopEventWatch("MatrixByMatrix");
        ...
        {
            StopWatchLogger.StartEventWatch("DotProduct");
            ...
            StopWatchLogger.StopEventWatch("DotProduct");
        ...
        {
            StopWatchLogger.StartEventWatch("VectorNorm");
            ...
            StopWatchLogger.StopEventWatch("VectorNorm");
        ...
        {
            StopWatchLogger.StartEventWatch("TranspositionMatrix");
            ...
            StopWatchLogger.StopEventWatch("TranspositionMatrix");
