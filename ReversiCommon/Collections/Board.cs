...
namespace ReversiCommon.Collections
{
    ...
    public static class Board
    {
        ...
        {
            StopWatchLogger.StartEventWatch("GetAllPutableIndex");
            ...
            StopWatchLogger.StopEventWatch("GetAllPutableIndex");
        ...
        {
            StopWatchLogger.StartEventWatch("GetAllPutablePointerCount");
            ...
            if (isOppositeTurn) { TurnKeeper.ChangeOnlyColor(); }
            StopWatchLogger.StopEventWatch("GetAllPutablePointerCount");
